...
require_relative "agentkit/exploration"
require_relative "agentkit/exploration/quota"
require_relative "agentkit/exploration/governance"
require_relative "agentkit/exploration/operations"
...
module Agentkit
  class << self
    ...
    def reset!
      ...
      Exploration.reset! if defined?(Exploration)
      self
    end
